...
const Place = () => {
    ...
    return (
        ...
        <h2 className="text-3xl mb-4 font-rebond">Add your favourite place!</h2>
        <p>
            Is it the park where you unwind, a cozy coffee shop, or a spot from
            your travels? Share a photo of the place that brings you joy and
            feels like home, where you can be you.
        </p>
